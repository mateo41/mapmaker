<%@ Page Language="C#" AutoEventWireup="true" CodeFile="storet.aspx.cs" Inherits="map" %>
    ...
    function postBackByObject(mEvent)
{
   ...
   <asp:XmlDataSource 
            ID="XmlDataSource3" runat="server" DataFile="~/App_Code/App_Data/STORET_2009.xml" 
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
      ...
      <esri:mapresourcemanager id="MapResourceManager1" runat="server" style="z-index: 101;
        ...
        <asp:XmlDataSource ID="XmlDataSource1" runat="server" 
            DataFile="~/App_Code/App_Data/STORET_2009.xml" 
      ...
      <esri:toolbar id="Toolbar1" runat="server" buddycontroltype="Map" group="Toolbar1_Group"
        height="50px" style="z-index: 102; left: 266px; position: absolute; top: 753px; width: 452px; margin-top: 2px;"
        ...
        webresourcelocation="/aspnet_client/ESRI/WebADF/" Width="450px" ><ToolbarItems>
