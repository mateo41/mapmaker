...
public partial class map : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            string databaseName = "HISCentral";
        ...
        if (Session["LayerDictionary"] == null)
        {
            ...
            layerDictionary.Add(0, ".[StateFIPS].[StateFIPS] ");
            layerDictionary.Add(1, ".[CountyFIPS].[CountyFIPS] ");
            layerDictionary.Add(2, ".[HUC2].[HUC2] ");
            layerDictionary.Add(3, ".[HUC4].[HUC4] ");
            layerDictionary.Add(4, ".[HUC6].[HUC6] ");
 ...
 * which executes javascript on the client */
   ...
   ESRI.ArcGIS.ADF.ArcGISServer.esriImageReturnType returnType)
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        host = "kyle";
        Dictionary<int, string> layerDictionary = (Dictionary<int, string>)Session["LayerDictionary"];
        sitesDim = (String)Session["SiteDim"];
